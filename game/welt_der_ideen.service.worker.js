...
/** @type {string} */
const CACHE_VERSION = '1745184804|4130060088';
/** @type {string} */
const CACHE_PREFIX = 'Mind Map World-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'welt_der_ideen.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["welt_der_ideen.html","welt_der_ideen.js","welt_der_ideen.offline.html","welt_der_ideen.icon.png","welt_der_ideen.apple-touch-icon.png","welt_der_ideen.audio.worklet.js","welt_der_ideen.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["welt_der_ideen.wasm","welt_der_ideen.pck"];
